...
👩‍💻 **SAP & Supply Chain**  
SAP IBP | SAP APO (DP, SNP, PP/DS) | SAP PP/MM | SAP ECC | S/4HANA  

📈 **Data Science & Analytics**  
Python | R | SQL | Power BI | Tableau | Machine Learning | Forecasting  

⚙️ **Process & Tools**  
Agile | JIRA | ServiceNow | CPI-DS | SDI | GitHub  

---

## 🚀 What I’m Working On
✨ Building real-time **IBP Demand & Supply Planning** dashboards  
📊 Experimenting with **forecast accuracy analytics** using Python  
🧠 Creating **machine learning models** for time series prediction  
💡 Sharing projects that combine **SAP + Data Science** on my GitHub  

---

## 💬 A Little More About Me

🌱 I’m always learning — currently exploring **Predictive Planning in SAP IBP**  
🧩 I love connecting dots between **business logic and algorithms**  
🌸 My creative side enjoys **designing dashboards and storytelling with data**  
☕ And yes… I never say no to **a cup of coffee and a brainstorming session!**

---

## 📬 Get In Touch

If you love talking about **data, supply chain planning, or analytics**, let’s connect!  
